...
function response(ctx) {
  if (!(this instanceof response)) return new response(ctx);
...
response.prototype = {
  ...
  get status() {
    return this.res.statusCode || null;
  },
  ...
  get message() {
    return this.res.statusMessage || statuses[this.status] || null;
  },
